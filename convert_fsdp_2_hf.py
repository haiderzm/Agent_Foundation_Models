...
def convert_fsdp_to_huggingface(checkpoint_dir, output_dir, base_model_path):
    ...
    print("\n[1/5] Loading FSDP sharded checkpoint...")
    ...
    # Step 3: Copy config and tokenizer files
    print("\n[3/5] Copying config and tokenizer files...")
    config_files = [
        'config.json', 
    ...
    # Step 4: Load base model and replace weights
    print("\n[4/5] Loading base model architecture...")
    ...
    print("\n[5/5] Loading merged weights into model...")
    # Load merged weights

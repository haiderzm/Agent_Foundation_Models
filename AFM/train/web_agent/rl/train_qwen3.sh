...
export WANDB_API_KEY="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"
export WANDB_PROJECT="qwen3_8b_rl"
export PROJECT_NAME="qwen3_8b_rl"
EXPERIMENT_DIR=$(dirname "$(readlink -f "$0")")
export EXPERIMENT_NAME="2-QWEN3-VL-8B-WebAgent-sglang-BS-16-Steps-480-Epoch-3-C-16k"
export BASE_MODEL="/home/Md.Zama@mbzuai.ac.ae/Agent_Foundation_Models/models/Qwen3-VL-checkpoint-952"   # your train model path
...
# =====================================================================================================================
cd verl
# PYTHONUNBUFFERED=1 torchrun --nproc_per_node=4 -m verl.trainer.main_ppo \
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    ...
    custom_reward_function.path="${CURRENT_DIR}/verl/verl/utils/reward_score/grm_simple.py" \
